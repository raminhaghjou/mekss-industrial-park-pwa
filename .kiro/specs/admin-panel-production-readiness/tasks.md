...
- [x] 2. [Required] Write the preservation property tests before implementing the fix
...
- [ ] 3. [Required] Implement the complete production-readiness bugfix in dependency order
  ...
  - [ ] 3.5 [Required] Implement the shared typed backend validation, canonical actor, error, transaction, and audit foundation
  ...
  - [x] 3.11 [Required] Complete invoice list/create behavior and remove unsupported mutations
  ...
  - [x] 3.12 [Required] Complete gate-pass and request review contracts
  ...
  - [x] 3.13 [Required] Complete announcement management contracts
  ...
  - [x] 3.14 [Required] Resolve messaging as a truthful durable operation
  ...
  - [x] 3.15 [Required] Complete reports with server-derived scoped analytics
  ...
  - [x] 3.16 [Required] Resolve notifications, settings, and SMS configuration truthfully
  ...
  - [x] 3.17 [Required] Build the shared frontend API, query, mutation, and classified-error layer
  ...
  - [x] 3.18 [Required] Build shared accessible forms, confirmations, localization, bidi, and operation registry primitives
  ...
  - [x] 3.19 [Required] Implement the premium Persian RTL visual system and professional authentication background
  ...
  - [x] 3.20 [Required] Rebuild responsive role-aware navigation and the accessible application shell
  ...
  - [x] 3.21 [Required] Implement compliant install-prompt lifecycle and offline mutation safety
  ...
  - [x] 3.22 [Required] Replace the role dashboard with real scoped operational data
  ...
  - [x] 3.23 [Required] Replace `ManageParksPage` mocks with complete API-backed park administration
  ...
  - [x] 3.24 [Required] Replace `ManageUsersPage` mocks with complete safe user administration
  ...
  - [x] 3.25 [Required] Replace advertisement mocks with one complete scoped moderation experience
  ...
  - [x] 3.26 [Required] Replace factory management mocks and no-op controls
  ...
  - [x] 3.27 [Required] Replace invoice creation/management mocks and unsupported controls
  ...
  - [x] 3.28 [Required] Replace gate-pass and request approval mocks
  ...
  - [x] 3.29 [Required] Replace announcement management mocks and no-op controls
  ...
  - [x] 3.30 [Required] Make messaging, reports, notifications, settings, and SMS pages truthful
  ...
  - [x] 3.31 [Required] Enforce the complete visible-operation truthfulness inventory
  ...
  - [x] 3.32 [Required] Complete cross-cutting WCAG 2.2 AA, Persian RTL, responsive, and state validation
  ...
  - [x] 3.33 [Required] Run backend, migration, and API integration/property validation
  ...
  - [x] 3.34 [Required] Run frontend unit, property, integration, and browser validation
  ...
  - [x] 3.35 [Required] Validate the production-shaped Docker stack and runtime boundaries
  ...
  - [x] 3.36 [Optional] Add extended visual-regression coverage for premium surfaces
  ...
  - [x] 3.37 [Required] Verify the original bug condition exploration test now passes
  ...
  - [x] 3.38 [Required] Verify the preservation property tests still pass
    - **Property 2: Preservation** - Security, Data, Deployment, and Other Roles
...
- [x] 4. [Required] Checkpoint - Ensure all required tests and acceptance gates pass
...
- Tasks 1, 2, 3.1, and 3.2 are complete; preserve their completion markers and recorded exploration, preservation, validation-infrastructure, and backend-boundary evidence. The next implementation task is 3.3. Continue in the numbered dependency order from task 3.3 without restarting tasks 1 or 2, and do not mark any later task complete until its coding, testing, build, or migration outcomes have been executed and recorded.
