...
<head>
    <title>Code coverage report for health-indicator/http/http.health.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">health-indicator/http</a> http.health.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { type URL } from 'url';
...
&nbsp;
  constructor(
    ...
    super();
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.logger instanceof ConsoleLogger) {
<span class="cstat-no" title="statement not covered" >      this.logger.setContext(HttpHealthIndicator.name);</span>
    }
