  ...
  "../../node_modules/.pnpm/debug@4.3.4/node_modules/debug/src/node.js"(exports, module2) {
    ...
    function init2(debug7) {
      ...
      for (let i = 0; i < keys.length; i++) {
        debug7.inspectOpts[keys[i]] = exports.inspectOpts[keys[i]];
      }
    }
    module2.exports = require_common()(exports);
    var { formatters } = module2.exports;
...
// ../../node_modules/.pnpm/@prisma+engines-version@5.7.1-1.0ca5ccbcfa6bdc81c003cf549abe4269f59c41e5/node_modules/@prisma/engines-version/package.json
var require_package = __commonJS({
  "../../node_modules/.pnpm/@prisma+engines-version@5.7.1-1.0ca5ccbcfa6bdc81c003cf549abe4269f59c41e5/node_modules/@prisma/engines-version/package.json"(exports, module2) {
    module2.exports = {
...
// ../../node_modules/.pnpm/@prisma+engines-version@5.7.1-1.0ca5ccbcfa6bdc81c003cf549abe4269f59c41e5/node_modules/@prisma/engines-version/index.js
var require_engines_version = __commonJS({
  "../../node_modules/.pnpm/@prisma+engines-version@5.7.1-1.0ca5ccbcfa6bdc81c003cf549abe4269f59c41e5/node_modules/@prisma/engines-version/index.js"(exports) {
    "use strict";
...
var require_windows = __commonJS({
  "../../node_modules/.pnpm/isexe@2.0.0/node_modules/isexe/windows.js"(exports, module2) {
    ...
    function sync(path7, options2) {
      return checkStat(fs6.statSync(path7), path7, options2);
    }
  }
});
...
var require_mode = __commonJS({
  "../../node_modules/.pnpm/isexe@2.0.0/node_modules/isexe/mode.js"(exports, module2) {
    ...
    function sync(path7, options2) {
      return checkStat(fs6.statSync(path7), options2);
    }
...
var require_semver = __commonJS({
  "../../node_modules/.pnpm/semver@5.7.1/node_modules/semver/semver.js"(exports, module2) {
    ...
    function Comparator(comp, options2) {
      ...
      debug7("comparator", comp, options2);
      this.options = options2;
      this.loose = !!options2.loose;
      this.parse(comp);
      if (this.semver === ANY) {
    ...
    function replaceXRanges(comp, options2) {
      debug7("replaceXRanges", comp, options2);
    ...
    function replaceStars(comp, options2) {
      debug7("replaceStars", comp, options2);
...
var require_spdx_license_ids = __commonJS({
  "../../node_modules/.pnpm/spdx-license-ids@3.0.16/node_modules/spdx-license-ids/index.json"(exports, module2) {
    module2.exports = [
      "0BSD",
      "AAL",
      "ADSL",
...
var require_main2 = __commonJS({
  "../../node_modules/.pnpm/dotenv@16.0.3/node_modules/dotenv/lib/main.js"(exports, module2) {
    ...
    function config(options2) {
      ...
      let encoding = "utf8";
      const debug7 = Boolean(options2 && options2.debug);
...
var require_jsonfile = __commonJS({
  "../../node_modules/.pnpm/jsonfile@6.1.0/node_modules/jsonfile/index.js"(exports, module2) {
    ...
    async function _readFile(file, options2 = {}) {
      ...
      const fs6 = options2.fs || _fs;
      const shouldThrow = "throws" in options2 ? options2.throws : true;
      let data = await universalify.fromCallback(fs6.readFile)(file, options2);
      data = stripBom(data);
      let obj;
      try {
    ...
    function readFileSync(file, options2 = {}) {
      ...
      const shouldThrow = "throws" in options2 ? options2.throws : true;
      try {
        let content = fs6.readFileSync(file, options2);
    ...
    async function _writeFile(file, obj, options2 = {}) {
      ...
      await universalify.fromCallback(fs6.writeFile)(file, str, options2);
    }
    var writeFile = universalify.fromPromise(_writeFile);
    function writeFileSync(file, obj, options2 = {}) {
      const fs6 = options2.fs || _fs;
      const str = stringify2(obj, options2);
      return fs6.writeFileSync(file, str, options2);
    }
    var jsonfile = {
      readFile: readFile2,
      readFileSync,
  ...
  "package.json"(exports, module2) {
    module2.exports = {
      ...
      devDependencies: {
        ...
        "@prisma/query-engine-wasm": "0.0.18",
...
var require_vendors = __commonJS({
  "../../node_modules/.pnpm/ci-info@4.0.0/node_modules/ci-info/vendors.json"(exports, module2) {
    module2.exports = [
      {
        name: "Agola CI",
        constant: "AGOLA",
...
var require_ci_info = __commonJS({
  "../../node_modules/.pnpm/ci-info@4.0.0/node_modules/ci-info/index.js"(exports) {
    "use strict";
...
function getClientEngineType(generatorConfig) {
  ...
  } else if (generatorConfig?.config.engineType === "wasm" /* Wasm */) {
    return "wasm" /* Wasm */;
  } else {
...
function buildModelOutputProperty(field, dmmf2) {
  ...
  if (field.kind === "object") {
    ...
    if (!dmmf2.isComposite(field.type)) {
...
function buildModelPayload(model, dmmf2) {
  const isComposite = dmmf2.isComposite(model.name);
  ...
  for (const field of model.fields) {
    if (field.kind === "object") {
      if (dmmf2.isComposite(field.type)) {
        composites.add(buildModelOutputProperty(field, dmmf2));
      } else {
        objects.add(buildModelOutputProperty(field, dmmf2));
      }
    } else if (field.kind === "enum" || field.kind === "scalar") {
      scalars.add(buildModelOutputProperty(field, dmmf2));
    }
  }
...
function getIncludeFields(fields, dmmf2) {
  return fields.filter((field) => {
    ...
    return !dmmf2.isComposite(field.outputType.type);
  });
}
...
var ModelDelegate = class {
  ...
  toTS() {
    ...
    const { dmmf: dmmf2 } = this.context;
    const mapping = dmmf2.mappingsMap[name] ?? { model: name, plural: `${name}s` };
    const modelOrType = dmmf2.typeAndModelMap[name];
    const availableActions = getModelActions(dmmf2, name);
...
${(0, import_indent_string4.default)(
      fields.filter((f) => {
        return f.outputType.location === "outputObjectTypes" && !dmmf2.isComposite(f.outputType.type) && f.name !== "_count";
      }).map((f) => {
        return `
...
function buildGetQueryEngineWasmModule(edge, engineType) {
  if (engineType !== "wasm" /* Wasm */) {
...
// src/generation/utils/buildNFTAnnotations.ts
function buildNFTAnnotations(noEngine2, engineType, platforms, relativeOutdir) {
  if (noEngine2 === true)
    return "";
  if (platforms === void 0) {
    return "";
...
var PrismaClientClass = class {
  constructor(dmmf2, internalDatasources, outputDir2, runtimeName, browser, generator2, cwd) {
    this.dmmf = dmmf2;
    this.internalDatasources = internalDatasources;
...
// src/generation/TSClient/TSClient.ts
var TSClient = class _TSClient {
  constructor(options2) {
    this.options = options2;
    this.dmmf = new DMMFHelper(klona(options2.document));
    this.genericsInfo = new GenericArgsInfo(this.dmmf);
    _TSClient.enabledPreviewFeatures = this.options.generator?.previewFeatures ?? [];
  }
  async toJS(edge = false) {
    const { platforms, generator: generator2, outputDir: outputDir2, schemaPath: schemaPath2, runtimeDir, runtimeName, datasources: datasources2, deno, noEngine: noEngine2 } = this.options;
...
async function buildClient({
  ...
  overrideEngineType: overrideEngineType2,
  noEngine: noEngine2
}) {
  const document2 = getPrismaClientDMMF(dmmf2);
  const clientEngineType2 = overrideEngineType2 ?? getClientEngineType(generator2);
  ...
  const nodeTsClient = new TSClient({
    ...tsClientOptions,
    runtimeName: getNodeRuntimeName(clientEngineType2),
...
To learn more about how to rename models, check out https://pris.ly/d/naming-models`;
  ...
  if (transpile === true && noEngine !== true && getClientEngineType(generator) !== "wasm" /* Wasm */) {
    if (process.env.NETLIFY) {
    ...
    for (const [binaryTarget, filePath] of Object.entries(enginePath)) {
      ...
      if (process.env.NETLIFY && !["rhel-openssl-1.0.x", "rhel-openssl-3.0.x"].includes(binaryTarget)) {
        ...
        target = import_path7.default.join(finalOutputDir, fileName);
      }
  ...
  if (getClientEngineType(generator) === "wasm" /* Wasm */) {
    const queryEngineWasmFilePath = import_path7.default.join(runtimeSourceDir, "query-engine.wasm");
    const queryEngineWasmTargetPath = import_path7.default.join(finalOutputDir, "query-engine.wasm");
    const dummyQueryEngineBgTargetPath = import_path7.default.join(finalOutputDir, "query_engine_bg.js");
    const dummyQueryEngineBgContents = "/** Dummy file needed by some bundlers when using `query-engine.wasm` */";
    const copyOrSymlink = testMode ? import_promises2.default.symlink : import_promises2.default.copyFile;
  ...
  if (!(0, import_fs5.existsSync)(proxyIndexJsPath)) {
    await import_promises2.default.copyFile(import_path7.default.join(__dirname, "../../index.js"), proxyIndexJsPath);
  }
  if (!(0, import_fs5.existsSync)(proxyIndexDTSPath)) {
    await import_promises2.default.copyFile(import_path7.default.join(__dirname, "../../index.d.ts"), proxyIndexDTSPath);
  }
  if (!(0, import_fs5.existsSync)(proxyIndexBrowserJsPath)) {
    await import_promises2.default.copyFile(import_path7.default.join(__dirname, "../../index-browser.js"), proxyIndexBrowserJsPath);
  }
  try {
...
async function deleteOutputDir(finalOutputDir2) {
  try {
    debug5(`attempting to delete ${finalOutputDir2} recursively`);
    if (require(`${finalOutputDir2}/package.json`).name === GENERATED_PACKAGE_NAME) {
      await import_promises2.default.rmdir(finalOutputDir2, { recursive: true }).catch(() => {
        debug5(`failed to delete ${finalOutputDir2} recursively`);
      });
    }
  } catch {
    debug5(`failed to delete ${finalOutputDir2} recursively, not found`);
  }
}
...
if (process.argv[1] === __filename) {
  generatorHandler({
    ...
    async onGenerate(options2) {
      const outputDir2 = parseEnvValue(options2.generator.output);
