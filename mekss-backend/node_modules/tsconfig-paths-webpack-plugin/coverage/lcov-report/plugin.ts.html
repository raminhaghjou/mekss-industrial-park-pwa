...
<head>
    <title>Code coverage report for plugin.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="index.html">All files</a> plugin.ts</h1>
        <div class='clearfix'>

            <div class='fl pad1y space-right2'>
                <span class="strong">68.96% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>80/116</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>51/78</span>
            </div>
...
<a name='L488'></a><a href='#L488'>488</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">1x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import * as chalk from "chalk";
...
&nbsp;
  constructor(<span class="missing-if-branch" title="if path not taken" >I</span>rawOptions: Partial&lt;Options.Options&gt; = {}) {
...
&nbsp;
    this.log = Logger.makeLogger(
      options,
      new chalk.Instance({ level: options.colors ? undefined : <span class="branch-1 cbranch-no" title="branch not covered" >0 </span>})
    );
&nbsp;
    const context = options.context || process.cwd();
    const loadFrom = options.configFile || <span class="branch-1 cbranch-no" title="branch not covered" >context;</span>
&nbsp;
    ...
    if (loadResult.resultType === "success") {
      ...
      this.absoluteBaseUrl = options.baseUrl
        ? <span class="branch-0 cbranch-no" title="branch not covered" >path.resolve(options.baseUrl)</span>
...
&nbsp;
  apply(resolver: Resolver): void {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!resolver) {
<span class="cstat-no" title="statement not covered" >      this.log.logWarning(</span>
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!("fileSystem" in resolver)) {
<span class="cstat-no" title="statement not covered" >      this.log.logWarning(</span>
...
&nbsp;
    ...
    } else <span class="cstat-no" title="statement not covered" ><span class="missing-if-branch" title="if path not taken" >I</span><span class="missing-if-branch" title="else path not taken" >E</span>if ("plugin" in resolver) {</span>
      // This is the legacy (Webpack &lt; 4.0.0) way of using the plugin system.
      const legacyResolver = <span class="cstat-no" title="statement not covered" >resolver as unknown as LegacyResolver;</span>
<span class="cstat-no" title="statement not covered" >      legacyResolver.plugin(</span>
        this.source,
        createPluginLegacy(
          this.matchPath,
...
function loadConfig(
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (loadResult.resultType === "failed") {
<span class="cstat-no" title="statement not covered" >    logger.logError(`Failed to load ${configPath}: ${loadResult.message}`);</span>
  } else {
    logger.logInfo(
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (
      !innerRequest ||
      request<span class="branch-0 cbranch-no" title="branch not covered" >?.r</span>equest<span class="branch-0 cbranch-no" title="branch not covered" >?.s</span>tartsWith(".") ||
      request<span class="branch-0 cbranch-no" title="branch not covered" >?.r</span>equest<span class="branch-0 cbranch-no" title="branch not covered" >?.s</span>tartsWith("..")
    ) {
    ...
    if (
      ...
      if (referenceMatchMap[request.path]) {
        ...
        const referenceUrl = Object.keys(referenceMatchMap).find(
          (refBaseUrl) =&gt; {
            const relative = path.relative(refBaseUrl, request.path || <span class="branch-1 cbranch-no" title="branch not covered" >"")</span>;
            return (
              relative &amp;&amp;
              !relative.startsWith("..") &amp;&amp;
...
&nbsp;
        return resolver.doResolve(
          ...
          (err2: Error, result2: ResolveRequest): void =&gt; {
            ...
            <span class="missing-if-branch" title="if path not taken" >I</span>if (err2) {
<span class="cstat-no" title="statement not covered" >              return callback(err2);</span>
            }
&nbsp;
            // Don't allow other aliasing or raw request
            <span class="missing-if-branch" title="if path not taken" >I</span>if (result2 === undefined) {
...
&nbsp;
function <span class="fstat-no" title="function not covered" >createPluginLegacy(</span>
  matchPath: TsconfigPaths.MatchPathAsync,
  ...
  const fileExistAsync = <span class="cstat-no" title="statement not covered" >createFileExistAsync(resolver.fileSystem);</span>
  const readJsonAsync = <span class="cstat-no" title="statement not covered" >createReadJsonAsync(resolver.fileSystem);</span>
<span class="cstat-no" title="statement not covered" >  return <span class="fstat-no" title="function not covered" >(r</span>equest, callback) =&gt; {</span>
    const innerRequest = <span class="cstat-no" title="statement not covered" >getInnerRequest(resolver, request);</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    matchPath(</span>
      innerRequest,
      readJsonAsync,
      fileExistAsync,
      extensions,
<span class="fstat-no" title="function not covered" >      (e</span>rr, foundMatch) =&gt; {
<span class="cstat-no" title="statement not covered" >        <span class="missing-if-branch" title="if path not taken" >I</span>if (err) {</span>
<span class="cstat-no" title="statement not covered" >          return callback(err);</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        <span class="missing-if-branch" title="if path not taken" >I</span>if (!foundMatch) {</span>
<span class="cstat-no" title="statement not covered" >          return callback();</span>
        }
&nbsp;
        const newRequest<span class="cstat-no" title="statement not covered" > = {</span>
          ...request,
          request: foundMatch,
          path: absoluteBaseUrl,
        };
&nbsp;
        ...
        const createInnerCallback: CreateInnerCallback = <span class="cstat-no" title="statement not covered" >require("enhanced-resolve/lib/createInnerCallback");</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        return (resolver.doResolve as doResolveLegacy)(</span>
          target,
          newRequest,
          `Resolved request '${innerRequest}' to '${foundMatch}' using tsconfig.json paths mapping`,
          createInnerCallback(<span class="fstat-no" title="function not covered" >function (e</span>rr2: Error, result2: string): void {
            // Note:
...
<span class="cstat-no" title="statement not covered" >            <span class="missing-if-branch" title="if path not taken" >I</span>if (arguments.length &gt; 0) {</span>
<span class="cstat-no" title="statement not covered" >              return callback(err2, result2);</span>
            }
&nbsp;
            // don't allow other aliasing or raw request
<span class="cstat-no" title="statement not covered" >            callback(undefined, undefined);</span>
          }, callback)
        );
      }
    );
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  fileSystem.readFile(path2, <span class="fstat-no" title="function not covered" >(e</span>rr, buf) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >    <span class="missing-if-branch" title="if path not taken" >I</span>if (err) {</span>
<span class="cstat-no" title="statement not covered" >      return callback(err);</span>
    }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      data = JSON.parse(buf.toString("utf-8"));</span>
    } catch (e) {
<span class="cstat-no" title="statement not covered" >      return callback(e);</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    return callback(undefined, data);</span>
  });
}
&nbsp;
...
function createFileExistAsync(
  ...
  return (
    ...
    filesystem.stat(path2, (err: Error, stats: fs.Stats) =&gt; {
      ...
      callback2(undefined, stats ? stats.isFile() : <span class="branch-1 cbranch-no" title="branch not covered" >false)</span>;
    });
  };
}
&nbsp;</pre></td></tr></table></pre>
