...
describe('active backend route contract', () => {
  ...
  it('preserves every active HTTP endpoint', () => {
    ...
    expect(routes).toEqual(
      [
        'GET /api/v1/advertisement-categories',
        'GET /api/v1/advertisement-categories/managed',
        'GET /api/v1/advertisements',
        'GET /api/v1/advertisements/creation-scope',
        'GET /api/v1/advertisements/favorites',
        'GET /api/v1/advertisements/mine',
        'GET /api/v1/advertisements/mine/:id',
        ...
        'GET /api/v1/gate-passes/by-plate/:plate',
        ...
        'GET /api/v1/market-rates/history',
        'GET /api/v1/messages/inbox',
        'GET /api/v1/messages/recipients',
        'GET /api/v1/messages/sent',
        'GET /api/v1/messages/unread-count',
        'GET /api/v1/notifications',
        'GET /api/v1/park-staff',
        'GET /api/v1/public/advertisements/featured',
        'GET /api/v1/public/announcements',
        'GET /api/v1/public/factories',
        'GET /api/v1/public/factories/:id',
        'GET /api/v1/public/parks',
        'GET /api/v1/public/shops',
        'GET /api/v1/reports',
        'GET /api/v1/requests',
        'GET /api/v1/settings/advertisement-featured',
        'GET /api/v1/settings/gate-pass-wallet',
        ...
        'DELETE /api/v1/advertisement-categories/:id',
        'DELETE /api/v1/advertisements/:id/favorite',
        'DELETE /api/v1/advertisements/mine/:id',
        'DELETE /api/v1/files/:id',
        'DELETE /api/v1/industrial-parks/:id',
        'DELETE /api/v1/park-staff/:id',
        'DELETE /api/v1/users/:id',
        'PATCH /api/v1/factories/:id/staff/:userId',
        'PATCH /api/v1/park-staff/:id',
        'PATCH /api/v1/settings/advertisement-featured',
        'PATCH /api/v1/settings/gate-pass-wallet',
        'PATCH /api/v1/users/:id',
        'POST /api/v1/advertisement-categories',
        'POST /api/v1/advertisements',
        'POST /api/v1/advertisements/:id/approve',
        'POST /api/v1/advertisements/:id/favorite',
        'POST /api/v1/advertisements/mine/:id/featured-request',
        ...
        'POST /api/v1/factories/:id/pending-changes/approve',
        'POST /api/v1/factories/:id/pending-changes/reject',
        ...
        'POST /api/v1/park-staff',
        'POST /api/v1/public/sms-requests',
        ...
        'PUT /api/v1/advertisement-categories/:id',
        'PUT /api/v1/announcements/:id',
        'PUT /api/v1/advertisements/mine/:id',
        'PUT /api/v1/auth/me',
        'PUT /api/v1/auth/me/default-driver',
        'PUT /api/v1/factories/:id',
        'PUT /api/v1/industrial-parks/:id',
        'PUT /api/v1/invoices/:id',
        'PUT /api/v1/market-rates/:key',
      ].sort(),
    );
  });
});
